...
print("***************************************************************************************")
print("*                                                                                     *")
print("*                      Welcome To Suresh Gyan Vihar Hospital System                   *")
print("*                                                                                     *")
print("***************************************************************************************")
		...
		if Admin_user_mode == "1" :																			#Admin mode
			...
			while True :
				...
				if   UserOptions == "1" :											#User mode --> view hospital's departments
							...
							for i in Doctors_DataBase :
								print(str(i) + " Name "+Doctors_DataBase[i][0][1]+" in "+Doctors_DataBase[i][0][0]+" department, from "+Doctors_DataBase[i][0][2])
